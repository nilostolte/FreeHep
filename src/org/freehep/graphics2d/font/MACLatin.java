...
public class MACLatin extends AbstractCharTable {
	...
	public MACLatin() {
			...
			nameToEnc.put("Acircumflex", new Integer(229));
			...
			nameToEnc.put("Adieresis", new Integer(128));
			...
			nameToEnc.put("Ccedilla", new Integer(130));
			...
			nameToEnc.put("Eacute", new Integer(131));
			...
			nameToEnc.put("Ecircumflex", new Integer(230));
			...
			nameToEnc.put("Edieresis", new Integer(232));
			...
			nameToEnc.put("Egrave", new Integer(233));
			...
			nameToEnc.put("Iacute", new Integer(234));
			...
			nameToEnc.put("Icircumflex", new Integer(235));
			...
			nameToEnc.put("Idieresis", new Integer(236));
			...
			nameToEnc.put("Igrave", new Integer(237));
			...
			nameToEnc.put("Ntilde", new Integer(132));
			...
			nameToEnc.put("Ocircumflex", new Integer(239));
			...
			nameToEnc.put("Odieresis", new Integer(133));
			...
			nameToEnc.put("Uacute", new Integer(242));
			...
			nameToEnc.put("Ucircumflex", new Integer(243));
			...
			nameToEnc.put("Udieresis", new Integer(134));
			...
			nameToEnc.put("Ugrave", new Integer(244));
			...
			nameToEnc.put("Ydieresis", new Integer(217));
			...
			nameToEnc.put("aacute", new Integer(135));
			...
			nameToEnc.put("acircumflex", new Integer(137));
			...
			nameToEnc.put("aring", new Integer(140));
			encToName[140]="aring";
			...
			nameToEnc.put("atilde", new Integer(139));
			...
			nameToEnc.put("breve", new Integer(249));
			encToName[249]="breve";
			...
			nameToEnc.put("bullet", new Integer(165));
			...
			nameToEnc.put("cedilla", new Integer(252));
			...
			nameToEnc.put("circumflex", new Integer(246));
			...
			nameToEnc.put("currency", new Integer(219));
			...
			nameToEnc.put("dagger", new Integer(160));
			...
			nameToEnc.put("daggerdbl", new Integer(224));
			...
			nameToEnc.put("degree", new Integer(161));
			...
			nameToEnc.put("dieresis", new Integer(172));
			...
			nameToEnc.put("divide", new Integer(214));
			...
			nameToEnc.put("dotaccent", new Integer(250));
			...
			nameToEnc.put("eacute", new Integer(142));
			...
			nameToEnc.put("ecircumflex", new Integer(144));
			...
			nameToEnc.put("edieresis", new Integer(145));
			...
			nameToEnc.put("egrave", new Integer(143));
			...
			nameToEnc.put("ellipsis", new Integer(201));
			...
			nameToEnc.put("exclamdown", new Integer(193));
			...
			nameToEnc.put("fi", new Integer(222));
			encToName[222]="fi";
			...
			nameToEnc.put("fraction", new Integer(218));
			...
			nameToEnc.put("germandbls", new Integer(167));
			...
			nameToEnc.put("grave", new Integer(96));
			encToName[96]="grave";
			...
			nameToEnc.put("guillemotleft", new Integer(199));
			...
			nameToEnc.put("guillemotright", new Integer(200));
			...
			nameToEnc.put("guilsinglleft", new Integer(220));
			...
			nameToEnc.put("guilsinglright", new Integer(221));
			...
			nameToEnc.put("hungarumlaut", new Integer(253));
			...
			nameToEnc.put("iacute", new Integer(146));
			...
			nameToEnc.put("icircumflex", new Integer(148));
			...
			nameToEnc.put("idieresis", new Integer(149));
			...
			nameToEnc.put("igrave", new Integer(147));
			...
			nameToEnc.put("logicalnot", new Integer(194));
			...
			nameToEnc.put("macron", new Integer(248));
			...
			nameToEnc.put("ntilde", new Integer(150));
			...
			nameToEnc.put("oacute", new Integer(151));
			...
			nameToEnc.put("ocircumflex", new Integer(153));
			...
			nameToEnc.put("ordfeminine", new Integer(187));
			...
			nameToEnc.put("ordmasculine", new Integer(188));
			...
			nameToEnc.put("paragraph", new Integer(166));
			...
			nameToEnc.put("periodcentered", new Integer(225));
			...
			nameToEnc.put("perthousand", new Integer(228));
			...
			nameToEnc.put("questiondown", new Integer(192));
			...
			nameToEnc.put("quotedblbase", new Integer(227));
			...
			nameToEnc.put("quotedblleft", new Integer(210));
			...
			nameToEnc.put("quotedblright", new Integer(211));
			...
			nameToEnc.put("quoteleft", new Integer(212));
			...
			nameToEnc.put("quoteright", new Integer(213));
			...
			nameToEnc.put("quotesinglbase", new Integer(226));
			...
			nameToEnc.put("quotesingle", new Integer(39));
			...
			nameToEnc.put("section", new Integer(164));
			...
			nameToEnc.put("uacute", new Integer(156));
			...
			nameToEnc.put("ucircumflex", new Integer(158));
			...
			nameToEnc.put("udieresis", new Integer(159));
			...
			nameToEnc.put("ugrave", new Integer(157));
