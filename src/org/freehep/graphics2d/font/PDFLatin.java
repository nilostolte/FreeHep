...
public class PDFLatin extends AbstractCharTable {
	...
	public PDFLatin() {
			...
			nameToEnc.put("AE", new Integer(198));
			encToName[198]="AE";
			...
			nameToEnc.put("Lslash", new Integer(149));
			encToName[149]="Lslash";
			...
			nameToEnc.put("OE", new Integer(150));
			encToName[150]="OE";
			...
			nameToEnc.put("Scaron", new Integer(151));
			encToName[151]="Scaron";
			...
			nameToEnc.put("Ydieresis", new Integer(152));
			encToName[152]="Ydieresis";
			...
			nameToEnc.put("Zcaron", new Integer(153));
			encToName[153]="Zcaron";
			...
			nameToEnc.put("breve", new Integer(24));
			encToName[24]="breve";
			...
			nameToEnc.put("bullet", new Integer(128));
			encToName[128]="bullet";
			...
			nameToEnc.put("caron", new Integer(25));
			encToName[25]="caron";
			...
			nameToEnc.put("circumflex", new Integer(26));
			encToName[26]="circumflex";
			...
			nameToEnc.put("dagger", new Integer(129));
			encToName[129]="dagger";

			unicodeToName.put(new Character((char)0x2021),"daggerdbl");
			nameToUnicode.put("daggerdbl",new Character((char)0x2021));
			nameToEnc.put("daggerdbl", new Integer(130));
			encToName[130]="daggerdbl";
			...
			nameToEnc.put("divide", new Integer(247));
			...
			nameToEnc.put("dotaccent", new Integer(27));
			encToName[27]="dotaccent";

			unicodeToName.put(new Character((char)0x0131),"dotlessi");
			nameToUnicode.put("dotlessi",new Character((char)0x0131));
			nameToEnc.put("dotlessi", new Integer(154));
			encToName[154]="dotlessi";
			...
			nameToEnc.put("fi", new Integer(147));
			encToName[147]="fi";
			...
			nameToEnc.put("fraction", new Integer(135));
			encToName[135]="fraction";
			...
			nameToEnc.put("guilsinglleft", new Integer(136));
			encToName[136]="guilsinglleft";

			unicodeToName.put(new Character((char)0x203a),"guilsinglright");
			nameToUnicode.put("guilsinglright",new Character((char)0x203a));
			nameToEnc.put("guilsinglright", new Integer(137));
			encToName[137]="guilsinglright";
			...
			nameToEnc.put("hungarumlaut", new Integer(28));
			encToName[28]="hungarumlaut";
			...
			nameToEnc.put("lslash", new Integer(155));
			encToName[155]="lslash";
			...
			nameToEnc.put("minus", new Integer(138));
			encToName[138]="minus";
			...
			nameToEnc.put("perthousand", new Integer(139));
			encToName[139]="perthousand";
			...
			nameToEnc.put("ring", new Integer(30));
			encToName[30]="ring";
			...
			nameToEnc.put("scaron", new Integer(157));
			encToName[157]="scaron";
			...
			nameToEnc.put("zcaron", new Integer(158));
